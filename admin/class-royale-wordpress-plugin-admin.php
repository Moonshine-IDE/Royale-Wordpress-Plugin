<?php
require_once __DIR__ . '/class-royale-wordpress-plugin-admin-pages.php';
...
class Royale_Wordpress_Plugin_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/royale-wordpress-plugin-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/royale-wordpress-plugin-admin.js', array( 'jquery' ), $this->version, false );
	...
	public function add_admin_pages() {
		$admin_pages = new Royale_Wordpress_Plugin_Admin_Pages();
